...
# app.config['SQLALCHEMY_DATABASE_URI']='postgresql://postgres:admin@localhost:5432/myduka_api'
#app.config['SQLALCHEMY_DATABASE_URI']='postgresql+psycopg2://myDuka_user:myDuka_pass@db:5432/myduka_api'
